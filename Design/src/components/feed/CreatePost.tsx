              ...
              >
                <div className="flex items-center gap-2">
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="p-3 rounded-2xl bg-[rgb(var(--muted))] text-[rgb(var(--muted-foreground))] hover:text-[rgb(var(--primary))] hover:bg-gradient-soft transition-all duration-300"
                    title="Add image"
                  >
