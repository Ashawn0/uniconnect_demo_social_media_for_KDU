...
import { Users, Search, Plus, Lock, TrendingUp, Star } from 'lucide-react';
import { motion } from 'motion/react';
import { Card } from '../ui/Card';
import { Button } from '../ui/Button';
import { Input } from '../ui/Input';
import { Badge } from '../ui/Badge';
import { Group, mockGroups } from '../../lib/mockData';
...
export const GroupsDirectory = ({ currentUserId, onSelectGroup }: GroupsDirectoryProps) => {
  ...
  const myGroups = groups.filter(g => g.members.includes(currentUserId));
                ...
                >
                  <Card hoverable className="p-6 h-full flex flex-col" gradient glow>
                    ...
                    >
                      ...
                      <Badge variant="gradient" className="mb-3">{group.category}</Badge>
              ...
              >
                <Card hoverable className="p-6 h-full flex flex-col" glass>
                  ...
                  >
                    ...
                    <Badge variant="primary" className="mb-3">{group.category}</Badge>
