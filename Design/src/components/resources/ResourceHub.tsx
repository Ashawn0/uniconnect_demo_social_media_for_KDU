...
import { Search, Upload, Download, FileText, File, Archive, Tag, Filter, Clock, TrendingUp } from 'lucide-react';
...
import { Resource, mockResources, mockUsers } from '../../lib/mockData';
          ...
          <div className="flex gap-2 overflow-x-auto pb-2 scrollbar-hide">
            {allTags.map((tag) => (
              <motion.button
                ...
                className={`px-5 py-2.5 rounded-2xl whitespace-nowrap font-medium transition-all duration-300 flex items-center gap-2 ${
                  selectedTag === tag
                    ...
                    <div className="flex gap-5">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-4 text-sm text-[rgb(var(--muted-foreground))]">
                            {uploader && (
                              <div className="flex items-center gap-2">
                                <Avatar src={uploader.avatar} alt={uploader.name} size="xs" gradient />
                          ...
                          <Button size="sm" variant="gradient" glow>
                            <Download className="w-4 h-4" />
                            Download
                          </Button>
                        </div>
        ...
        <div className="lg:col-span-4 space-y-6">
          ...
          <Card className="p-6" glass>
            ...
            <div className="space-y-4">
              {[
                { label: 'Total Resources', value: resources.length, color: 'primary' },
                { label: 'Total Downloads', value: resources.reduce((sum, r) => sum + r.downloadCount, 0), color: 'success' },
                { label: 'Your Uploads', value: 3, color: 'accent' },
              ].map((stat) => (
